...
const Board = () => {
  ...
  let isWinner =  (status.indexOf('No') < 0);

  // Part 1 step 1 code goes here
  // Use conditional logic to set a variable to either 'Player O' or  'Player X'
  const mark = player == 0 ? 'O' : 'X';
  let nextPlayer = `Next Player: Player ${mark}`;
  ...
  function renderSquare(i) {
    ...
    return <Square takeTurn={takeTurn} id={i} winner={isWinner}></Square>;
  }
...
const Square = ({ takeTurn, id, winner }) => {
  ...
  console.log(`square Winner: ${winner}`);
